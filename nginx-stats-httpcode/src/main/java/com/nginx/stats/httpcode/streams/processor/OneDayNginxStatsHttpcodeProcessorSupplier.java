    ...
    public Processor<String, NginxStatsHttpcode, String, NginxStatsHttpcode> get() {
        return new Processor<>() {
            ...
            public void init(ProcessorContext<String, NginxStatsHttpcode> context) {
                ...
                this.store = context.getStateStore(DefineKeyword.ONE_DAY_NGINX_STATS_HTTPCODE_STORE_NAME);
                this.keyStore = context.getStateStore(DefineKeyword.ONE_DAY_NGINX_STATS_HTTPCODE_KEY_STORE_NAME);
            ...
            public void process(Record<String, NginxStatsHttpcode> r) {
                ...
                System.out.println("OneDay: " + statTime + ", " + storeKey);
    ...
    public Set<StoreBuilder<?>> stores() {
        StoreBuilder<KeyValueStore<String, NginxStatsHttpcode>> keyValueStoreBuilder =
            Stores.keyValueStoreBuilder(
                    Stores.persistentKeyValueStore(DefineKeyword.ONE_DAY_NGINX_STATS_HTTPCODE_STORE_NAME),
        ...
        StoreBuilder<KeyValueStore<String, String>> keyStoreBuilder =
            Stores.keyValueStoreBuilder(
                    Stores.inMemoryKeyValueStore(DefineKeyword.ONE_DAY_NGINX_STATS_HTTPCODE_KEY_STORE_NAME),
