...
@Slf4j
public class FiveMinNginxStatsBytesProcessorSupplier extends NginxStatsBytesAggregator implements
    ...
    public Processor<String, NginxStatsBytes, String, NginxStatsBytes> get() {
        return new Processor<>() {
            ...
            public void init(ProcessorContext<String, NginxStatsBytes> context) {
                ...
                this.store = context.getStateStore(DefineKeyword.FIVE_MIN_NGINX_STATS_BYTES_STORE_NAME);
                this.keyStore = context.getStateStore(DefineKeyword.FIVE_MIN_NGINX_STATS_BYTES_KEY_STORE_NAME);
                this.stateStoreKey = new StateStoreKey();
                this.timeGroup = new TimeGroup(TimeGroup.FIVE_MIN_SEC, 12, new TimeYMDHM());
            }
    ...
    public Set<StoreBuilder<?>> stores() {
        StoreBuilder<KeyValueStore<String, NginxStatsBytes>> keyValueStoreBuilder =
            Stores.keyValueStoreBuilder(
                    Stores.persistentKeyValueStore(DefineKeyword.FIVE_MIN_NGINX_STATS_BYTES_STORE_NAME),
        ...
        StoreBuilder<KeyValueStore<String, String>> keyStoreBuilder =
            Stores.keyValueStoreBuilder(
                    Stores.inMemoryKeyValueStore(DefineKeyword.FIVE_MIN_NGINX_STATS_BYTES_KEY_STORE_NAME),
